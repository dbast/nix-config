{
  ...
  inputs = {
    ...
    # renovate: datasource=github-tags depName=disko packageName=nix-community/disko versioning=semver extractVersion=^v(?<version>.*)$
    disko.url = "github:nix-community/disko/1.13.0";
